...
deco = model.layers[-15](encoded_input)
...
#                    Train Model                  #
# ----------------------------------------------- #
model.load_weights("./Models/DenseLeakyRelu.hdf5")
...
encodedA = pure_encoder.predict(img.reshape(1,128,128,3));
encodedB = pure_encoder.predict(img2.reshape(1,128,128,3));
