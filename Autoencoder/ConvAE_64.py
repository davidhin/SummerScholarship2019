...
encoded_input = Input(shape=(8,8,1))
...
model.load_weights("Models/AutoEncoder_Cifar10_Deep_weights.10-0.62-0.62.hdf5") 
...
decoded_dists = []
for i in range(10):
    decoded_dists.append(decoder.predict(normal_dists[i].reshape(1,8,8,1)))
