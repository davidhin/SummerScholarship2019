...
# imageA = scipy.io.loadmat('../ConvAE/imageA.mat')['A'].reshape(1,128,128,3)
# imageB = scipy.io.loadmat('../ConvAE/imageB.mat')['B'].reshape(1,128,128,3)

img=mpimg.imread('../TrainingImages/train/img_1.png')
img2=mpimg.imread('../TrainingImages/train/img_2.png')

x_test[0] = img;
x_test[1] = img2;

encodedA = encoder.predict(img.reshape(1,128,128,3));
encodedB = encoder.predict(img2.reshape(1,128,128,3));
...
# 
# decoded_img = decoder.predict(encoded_img, verbose=1);
# plt.imshow(decoded_img.reshape(128,128,3))
# plt.show()
# 
# scipy.io.savemat('./encoded_64Dense.mat', mdict={'encoded_img': encoded_img})
# sys.exit() 
